...
import com.arantes.cleanarch.core.usecase.InsertCostumerUseCase;
...
public class CustomerController {
    ...
    @Autowired
    private UpdateCustomerUseCase updateCustomerByIdUseCase;
    ...
    public ResponseEntity<Void> insert(@Valid @RequestBody CustomerRequest customerRequest) {
        ...
        insertCostumerUseCase.insert(customer, customerRequest.getZipCode());
